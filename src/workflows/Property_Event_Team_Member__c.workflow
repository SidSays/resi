...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <actions>
            <name>Notify_when_a_member_is_added_to_a_property_event</name>
            <type>Alert</type>
        </actions>
        <actions>
        ...
        <active>true</active>
        <formula>OR(AND(( ISCHANGED( Name ) || ISCHANGED( Property_Event__c ) ||  ISCHANGED(  Email__c ) ), NOT( ISBLANK(Name) ) , NOT( ISBLANK(Property_Event__c) )  ),
AND( NOT( ISBLANK(Name) ) , NOT( ISBLANK(Property_Event__c) ), ISNEW() ))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Property Event Team Member</fullName>
        <active>false</active>
        <formula>AND( NOT( ISBLANK(Name) ) , NOT( ISBLANK(Property_Event__c) ) )</formula>
